...
<body>
	...
	<c:url var="addDurationFormURL" value="/tasks/addDurationToTask" />
	<form:form method="POST" action="${addDurationFormURL}"
						...
						<div class="row">
							<div class="form-group">
								<div class="input-group date" id="datetimepicker1"
									...
									<form:input id="hidden-start" path="start" maxlength="12"
										required="required" class="form-control datetimepicker-input"
						...
						<div class="row">
							<div class="form-group">
								<div class="input-group date" id="datetimepicker2"
									data-target-input="nearest">
									<form:input id="hidden-end" path="end" maxlength="12"
										required="required" class="form-control datetimepicker-input"
	...
	<table class="table">
		<c:forEach var="duration" items="${durations}">
			<tr>
				<td>Duration Name: <a
					href="<c:url value="/durations/${duration.id}"/>"><c:out
							value="${duration.parent.parent.name}-${duration.parent.name} ${duration.name}" /></a></td>
		    ...
		    -->
				<td>Duration Description: <c:out
						value="${duration.description}" /></td>
				<td>Duration Start: <fmt:formatDate value="${duration.start}"
						pattern="yyyy-MM-dd HH:mm:ss" /></td>
				<td>Duration End: <fmt:formatDate value="${duration.end}"
						pattern="yyyy-MM-dd HH:mm:ss" /></td>
